...
import com.dfyy.framework.shiro.realm.UserRealm;
import com.dfyy.framework.shiro.session.OnlineSessionDAO;
import com.dfyy.framework.shiro.session.OnlineSessionFactory;
import com.dfyy.framework.shiro.web.filter.LogoutFilter;
import com.dfyy.framework.shiro.web.filter.online.OnlineSessionFilter;
import com.dfyy.framework.shiro.web.filter.sync.SyncOnlineSessionFilter;
import com.dfyy.framework.shiro.web.session.OnlineWebSessionManager;
import com.dfyy.framework.shiro.web.session.SpringSessionValidationScheduler;
...
public class ShiroConfig
{
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager)
    {
        ...
        filterChainDefinitionMap.put("/dfyy.png**", "anon");
        ...
        filterChainDefinitionMap.put("/dfyy/**", "anon");
        filterChainDefinitionMap.put("/druid/**", "anon");
        filterChainDefinitionMap.put("/imgfile/**", "anon");
        filterChainDefinitionMap.put("/jQueryLogin/**", "anon");
        // 不需要拦截的访问
