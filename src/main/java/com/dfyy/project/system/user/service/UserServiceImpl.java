...
import com.dfyy.framework.shiro.service.PasswordService;
import com.dfyy.project.system.post.dao.IPostDao;
import com.dfyy.project.system.post.domain.Post;
import com.dfyy.project.system.role.dao.IRoleDao;
import com.dfyy.project.system.role.domain.Role;
import com.dfyy.project.system.user.dao.IUserDao;
import com.dfyy.project.system.user.dao.IUserPostDao;
import com.dfyy.project.system.user.dao.IUserRoleDao;
import com.dfyy.project.system.user.domain.User;
import com.dfyy.project.system.user.domain.UserPost;
import com.dfyy.project.system.user.domain.UserRole;
...
public class UserServiceImpl implements IUserService {
	...
	public int deleteUserById(Long userId) {
		...
		// 删除用户与岗位表
		return userPostDao.deleteUserPostByUserId(userId);
	...
	public int saveUser(User user) {
		...
		if (StringUtils.isNotNull(userId)) {
			...
			User uu = userDao.selectUserById(userId);


			if (user.getDeptId() == null) {
				user.setDeptId(100);// 如果没有，设默认值
			}
			user.randomSalt();
	...
	public int deleteUserByUserNumber(String userNumber) {
		return userDao.deleteUserByUserNumber(userNumber);
	}
	...
	public Map<String, Object> selectUserByPhoneAndUserId(Map<String, Object> ma) {
		return userDao.selectUserByPhoneAndUserId(ma);
	}
}
