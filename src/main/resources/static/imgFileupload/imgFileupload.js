~(function(win){
	var htmls = '<input type="file" name="file" id="file" class="imgFiles" style="display: none" accept="image/gif,image/jpeg,image/jpg,image/png,image/svg" multiple>'+
				'<div class="header">'+
				'    <span class="imgTitle">'+
				'        图片上传'+
				'        <b>'+
	...
	ImgUploadeFiles.prototype = {
		...
		ready : function(){
			...
			this.imgcontent.innerHTML = '请上传图片';
